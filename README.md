...
All agents use dedicated system prompts under `prompts/agents/<name>/system.md`.
They outline each agent's role, responsibilities, allowed tools and response
format. The global prompt at `prompts/global/system.md` specifies common
policies. Changes to prompts follow the approval process described in
[`docs/prompt_approval.md`](docs/prompt_approval.md).
